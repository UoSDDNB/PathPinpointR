...
```{r}
ppr_precision(sce = reference_sce, r2_cutoff_range = seq(0.15, 0.8, 0.01))
#0.278

bin_mat1 <- samples_reduced[[1]]@assays@data@listData$binary
bin_mat2 <- samples_reduced[[2]]@assays@data@listData$binary
bin_mat3 <- samples_reduced[[3]]@assays@data@listData$binary
bin_mat4 <- samples_reduced[[4]]@assays@data@listData$binary
bin_mat5 <- samples_reduced[[5]]@assays@data@listData$binary
```
