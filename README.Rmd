...
You can install the development version of PathPinpointR from [GitHub](https://github.com/) with:
...
[GSS Workflow](https://moi-taiga.github.io/PathPinPointR/articles/GSS_Workflow.html)
