...
use r2cutoff to select the number of switching genes.
```{r}
...
Note: The choice of r2cutoff significantly affects the accuracy of PPR.
  too many switching genes will reduce the accuracy of the prediction by including uninformative genes/noise.
  too few switching genes will reduce the accuracy of the prediction by excluding informative genes.
...
```{r}
precision(sce, r2_cutoff_range = seq(0.271, 0.279, 0.001))
