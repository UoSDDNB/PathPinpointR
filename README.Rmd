...
sce    <- readRDS("/mainfs/ddnb/PathPinpointR/package/data/switches_gastglm_blastocyst_reference_sce.rds")
```
...
plot_position(samples_ppr[[1]], col = "red", overlay=FALSE, label = names(samples_ppr)[1])
plot_position(samples_ppr[[2]], col = "blue", overlay=TRUE, label = names(samples_ppr)[2])
plot_position(samples_ppr[[4]], col = "purple", overlay=TRUE, label = names(samples_ppr)[4])
plot_position(samples_ppr[[5]], col = "#000000", overlay=TRUE, label = names(samples_ppr)[5])
plot_position(samples_ppr[[8]], col = "#4dd80c", overlay=TRUE, label = names(samples_ppr)[8])
```
